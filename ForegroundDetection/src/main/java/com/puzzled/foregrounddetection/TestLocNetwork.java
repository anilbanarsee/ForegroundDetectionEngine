...
public class TestLocNetwork {
        ...
        BasicNetwork network = (BasicNetwork)EncogDirectoryPersistence.loadObject(new File("locationtrain.eg"));
            ...
            for (int x = 0; x < image.getWidth(); x++) {
                ...
                final int blue = clr & 0x000000ff;
                  ...
                  double xpos = x;
                    ...
                    ypos = ypos/image.getHeight();
                
                inputs[x] = new double[]{1, xpos, ypos, xpos*xpos, ypos*ypos, xpos*ypos};
